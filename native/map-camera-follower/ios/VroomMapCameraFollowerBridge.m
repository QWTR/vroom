...
RCT_EXPORT_VIEW_PROPERTY(speedMps, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(segmentDurationMs, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(diagnosticsEnabled, BOOL)
RCT_EXPORT_VIEW_PROPERTY(onMotionDiagnostics, RCTDirectEventBlock)

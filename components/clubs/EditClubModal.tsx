...
import { ActivityIndicator, Alert, KeyboardAvoidingView, Modal, Platform, ScrollView, StyleSheet, Switch, TouchableOpacity, View } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  eyebrow: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '800', letterSpacing: 1, marginBottom: 3 },
  headerTitle: { fontFamily: 'Manrope_600SemiBold', fontSize: 14, fontWeight: '900' },
  ...
  statusText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '800' },
  ...
  tabLabel: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '700' },
  ...
  panelTitle: { fontFamily: 'Manrope_600SemiBold', fontSize: 14, fontWeight: '900', marginBottom: 4 },
  panelSubtitle: { fontSize: 12, lineHeight: 16 },
  card: { borderRadius: 18, borderWidth: 1, padding: 14 },
  cardTitle: { flex: 1, fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '800' },
  ...
  fieldLabel: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '800', letterSpacing: 1, marginBottom: 7, marginTop: 2 },
  ...
  primaryButtonText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900', letterSpacing: 0.5 },
  ...
  categoryTitleInput: { flex: 1, fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900', letterSpacing: 1, paddingVertical: 5 },
  ...
  metaBadgeText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '800' },
  emptyLine: { fontSize: 12, fontStyle: 'italic', paddingHorizontal: 12, paddingBottom: 12 },
  ...
  permissionDescription: { fontSize: 12, lineHeight: 16 },
  ...
  emptyTitle: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '800', marginTop: 9, marginBottom: 5 },
  emptySubtitle: { fontSize: 12, textAlign: 'center', lineHeight: 16 },
  counter: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '800', borderRadius: 999, paddingHorizontal: 8, paddingVertical: 5 },
  ...
  actionText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '800' },

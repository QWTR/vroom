...
const styles = StyleSheet.create({ safe: { flex: 1 }, content: { flex: 1, padding: 28, alignItems: 'center', justifyContent: 'center', gap: 16 }, title: { fontFamily: 'OrbitronBold', textAlign: 'center', fontSize: 16, letterSpacing: 1.2 }, message: { textAlign: 'center', fontSize: 12, lineHeight: 19 }, primary: { minWidth: 210, minHeight: 48, borderRadius: 12, backgroundColor: '#FFD447', alignItems: 'center', justifyContent: 'center' }, primaryText: { color: '#111', fontWeight: '900' }, secondary: { minWidth: 210, minHeight: 48, borderWidth: 1, borderRadius: 12, alignItems: 'center', justifyContent: 'center' } });

...
export function makeMapStyles(
  ...
  return StyleSheet.create({
    ...
    loaderText: {
      color: t.primary, fontFamily: 'Manrope_600SemiBold',
      fontSize: 13, letterSpacing: 0.2, marginTop: 4,
    },
    ...
    carMarker: {
      ...
      shadowOpacity: 0.16, shadowRadius: 6, elevation: 8,
    },
    userCarMarkerContainer: { alignItems: 'center', justifyContent: 'center', paddingBottom: 4 },
    userCarMarkerLabel: {
      color: t.mapLabelText, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.5,
    ...
    userCarMarkerDistance: {
      color: t.primary, fontSize: 13, fontFamily: 'Manrope_600SemiBold',
    ...
    userCarMarker: {
      ...
      shadowOpacity: 0.16, shadowRadius: 4, elevation: 6,
    },
    userMarker: {
    ...
    userMarkerName:     { fontSize: 13, color: t.text, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.5 },
    userMarkerDistance: { fontSize: 13, color: t.primary, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.5, marginTop: 2 },
    ...
    topSearchButtonText: {
      color: t.text, fontSize: 16, fontFamily: 'Manrope_600SemiBold',
      letterSpacing: 0.2, flex: 1, marginHorizontal: 10,
    },
    ...
    instructionBox: { paddingRight: 36 },
    instructionDistance: {
    ...
    routeInfoLocationName: { color: t.textMuted, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.5, flex: 1 },
    ...
    statLabel: { color: t.textDim, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.2, marginBottom: 4 },
    statValue: { color: t.text, fontSize: 15, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', letterSpacing: -0.5 },
    ...
    navigateButton: {
      ...
      shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.16, shadowRadius: 6,
    },
    navigateButtonText: { color: t.onPrimary, fontSize: 13, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', letterSpacing: 1.5 },
    editButton: {
    ...
    emptyTitle:    { color: t.text, fontSize: 12, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', letterSpacing: 3 },
    emptySubtitle: { color: t.textDim, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.2, textAlign: 'center', marginHorizontal: 24 },
    ...
    searchModalContainer: {
      ...
      shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.16, shadowRadius: 12,
      zIndex: 12,
    },
    searchModalHeader: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, marginBottom: 20, gap: 12 },
    searchModalBackBtn: {
      width: 44, height: 44, backgroundColor: SURF2, borderRadius: 12,
      borderWidth: 1, borderColor: t.border2, alignItems: 'center', justifyContent: 'center',
    },
    searchModalTitle: { color: t.text, fontSize: 18, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', letterSpacing: 0.2, flex: 1 },
    ...
    searchModalTabText:       { color: t.textDim, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 1 },
    searchModalTabTextActive: { color: t.primary, fontFamily: 'Manrope_600SemiBold', letterSpacing: 1 },
    ...
    searchModalInput:  { flex: 1, color: t.text, fontSize: 12, fontFamily: 'Manrope_600SemiBold', paddingVertical: 0, letterSpacing: 0.5 },
    searchHelperText:  { color: t.textDim, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.2, marginHorizontal: 16, marginBottom: 14 },
    searchResultsList: {
    ...
    searchResultItemText:    { color: t.text, fontSize: 12, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', letterSpacing: 0.2 },
    searchResultMeta:        { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 4 },
    userStatusDot:           { width: 6, height: 6, borderRadius: 3 },
    searchResultMetaText:    { color: t.textDim, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.5 },
    ...
    categoryTitle:        { color: t.text, fontSize: 12, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', letterSpacing: 0.3, marginBottom: 3 },
    categorySubtitle:     { color: t.textDim, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 1 },
    emptyList:            { justifyContent: 'center', alignItems: 'center', paddingVertical: 48, gap: 12 },
    emptyListText:        { color: t.textDim, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 2 },
    ...
    userInfoCard: {
      ...
      elevation: 20, shadowColor: '#000',
      shadowOffset: { width: 0, height: -4 }, shadowOpacity: 0.16, shadowRadius: 12,
    },
    ...
    userInfoName:        { color: t.text, fontSize: 20, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', letterSpacing: 0.5 },
    userInfoStatusRow:   { flexDirection: 'row', alignItems: 'center', gap: 6 },
    userInfoStatusDot:   { width: 7, height: 7, borderRadius: 4 },
    userInfoStatus:      { color: t.textDim, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 2 },
    ...
    userInfoStatLabel:   { color: t.textDim, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.2, marginBottom: 2 },
    userInfoStatValue:   { color: t.text, fontSize: 16, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', letterSpacing: -0.5 },
    ...
    userInfoBadgeText:   { color: '#ff6b9d', fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 1.5 },
    userInfoNavigateBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, paddingVertical: 15, backgroundColor: t.primary, borderRadius: 14, borderWidth: 1, borderColor: t.primaryBorder, elevation: 4, shadowColor: t.primary, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.16, shadowRadius: 6 },
    userInfoNavigateBtnText: { color: t.onPrimary, fontSize: 13, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', letterSpacing: 2 },
    ...
    drawerTitle:          { color: t.text, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', fontSize: 13, letterSpacing: 0.2, marginBottom: 20 },
    ...
    drawerBtnTxt:         { color: t.textMuted, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.2, flex: 1 },
    ...
    drawerSectionLabel:   { color: t.textDim, fontSize: 13, fontFamily: 'Manrope_600SemiBold', letterSpacing: 0.2, marginBottom: 10 },
    ...
    reportItemText:  { color: t.text, fontSize: 13, fontFamily: 'Manrope_600SemiBold', fontWeight: '700', letterSpacing: 0.5, flex: 1 },

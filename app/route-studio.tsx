...
const s = StyleSheet.create({ safe: { flex: 1 }, mapWrap: { flex: 1, backgroundColor: '#090909' }, mapCanvas: { width: '100%', height: '100%' }, top: { position: 'absolute', top: 52, left: 14, right: 14, flexDirection: 'row', gap: 9, alignItems: 'center' }, circle: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#050505e8', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#ffffff20' }, search: { flex: 1, height: 48, borderRadius: 16, backgroundColor: '#050505e8', borderWidth: 1, borderColor: '#ffffff20', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14, gap: 9 }, searchText: { color: '#fff', fontSize: 12, fontWeight: '800', flex: 1 }, mapHint: { position: 'absolute', top: 112, alignSelf: 'center', borderRadius: 14, backgroundColor: '#050505e8', borderWidth: 1, borderColor: '#ffffff1e', paddingHorizontal: 13, paddingVertical: 9, alignItems: 'center' }, mapHintTitle: { color: '#fff', fontSize: 12, fontWeight: '900', letterSpacing: 0.6 }, legendRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 6 }, legendDot: { width: 7, height: 7, borderRadius: 4 }, legendText: { color: '#ffffff86', fontSize: 12, fontWeight: '900', marginRight: 5 }, sheet: { maxHeight: '49%', borderTopLeftRadius: 24, borderTopRightRadius: 24, borderWidth: 1, borderBottomWidth: 0 }, sheetContent: { padding: 14, gap: 10, paddingBottom: 32 }, grabber: { width: 42, height: 4, borderRadius: 2, backgroundColor: '#ffffff30', alignSelf: 'center' }, name: { borderWidth: 1, borderRadius: 13, paddingHorizontal: 13, height: 45, fontSize: 14, fontWeight: '800' }, chip: { borderWidth: 1, borderRadius: 999, paddingHorizontal: 11, paddingVertical: 8 }, warning: { color: '#FFD447', backgroundColor: '#FFD44710', borderRadius: 10, padding: 10, fontSize: 12, lineHeight: 16 }, point: { minHeight: 52, borderWidth: 1, borderRadius: 12, paddingHorizontal: 8, flexDirection: 'row', alignItems: 'center', gap: 6 }, pointNo: { width: 28, height: 28, borderRadius: 14, alignItems: 'center', justifyContent: 'center' }, pointNoText: { color: '#111', fontWeight: '900', fontSize: 12 }, pointName: { fontSize: 12, minWidth: 70, paddingVertical: 2, paddingHorizontal: 3 }, dragAnchor: { width: 46, height: 46, borderRadius: 23, backgroundColor: '#ffffff01' }, marker: { width: 30, height: 30, borderRadius: 15, borderWidth: 3, borderColor: '#fff', alignItems: 'center', justifyContent: 'center' }, markerText: { color: '#111', fontWeight: '900', fontSize: 12 }, alternative: { minWidth: 130, borderWidth: 1, borderRadius: 12, padding: 10 }, primary: { height: 49, backgroundColor: '#FFD447', borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, primaryText: { color: '#111', fontWeight: '900', fontSize: 12 }, error: { color: '#ef4444', fontSize: 12, textAlign: 'center' } });

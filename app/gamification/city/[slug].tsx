...
const styles = StyleSheet.create({
  safe: { flex: 1 }, loading: { flex: 1, alignItems: 'center', justifyContent: 'center' }, header: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 18, paddingVertical: 10 }, back: { width: 44, height: 44, borderRadius: 14, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, kicker: { fontFamily: 'Orbitron', fontSize: 9, letterSpacing: 2.5, fontWeight: '900' }, title: { fontFamily: 'Orbitron', fontSize: 21, fontWeight: '900', marginTop: 3 }, content: { padding: 18, paddingBottom: 40, gap: 13 }, error: { textAlign: 'center', fontSize: 12, fontWeight: '800' }, hero: { borderWidth: 1, borderRadius: 22, padding: 18 }, heroHead: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }, province: { fontSize: 12, fontWeight: '700' }, percent: { fontFamily: 'Orbitron', fontSize: 28, fontWeight: '900', marginTop: 5 }, track: { height: 8, borderRadius: 99, overflow: 'hidden' }, fill: { height: '100%', borderRadius: 99 }, hint: { fontSize: 11, lineHeight: 16, fontWeight: '700', marginTop: 10 }, owner: { borderWidth: 1, borderRadius: 20, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 12 }, myBox: { borderWidth: 1, borderRadius: 20, padding: 16 }, myLabel: { fontFamily: 'Orbitron', fontSize: 9, letterSpacing: 1.3, fontWeight: '900' }, myValue: { fontFamily: 'Orbitron', fontSize: 21, fontWeight: '900', marginVertical: 7 }, section: { borderWidth: 1, borderRadius: 20, padding: 15, gap: 9 }, sectionHead: { flexDirection: 'row', alignItems: 'center', gap: 9, marginBottom: 2 }, sectionTitle: { fontFamily: 'Orbitron', fontSize: 14, fontWeight: '900' }, row: { borderWidth: 1, borderRadius: 14, padding: 12 }, rowTitle: { fontSize: 13, fontWeight: '900' }, rowMeta: { fontSize: 10, lineHeight: 15, fontWeight: '700', marginTop: 3 }, empty: { fontSize: 11, lineHeight: 17, fontWeight: '700' },
});

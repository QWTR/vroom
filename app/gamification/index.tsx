...
const styles = StyleSheet.create({
  header: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 18, paddingTop: 8, paddingBottom: 12 }, iconButton: { width: 44, height: 44, borderRadius: 14, borderWidth: 1, alignItems: 'center', justifyContent: 'center' }, kicker: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, letterSpacing: 1, fontWeight: '800' }, title: { fontFamily: 'Manrope_600SemiBold', fontSize: 23, letterSpacing: 1, fontWeight: '900', marginTop: 3 }, loading: { flex: 1, alignItems: 'center', justifyContent: 'center' }, content: { padding: 18, paddingBottom: 40 },
  hero: { borderWidth: 1, borderRadius: 22, padding: 18, flexDirection: 'row', alignItems: 'center', gap: 14 }, heroTitle: { fontFamily: 'Manrope_600SemiBold', fontSize: 22, fontWeight: '900', marginTop: 8 }, heroText: { fontSize: 13, lineHeight: 19, marginTop: 8, fontWeight: '600' }, heroBadge: { width: 82, height: 96, borderRadius: 20, borderWidth: 1, alignItems: 'center', justifyContent: 'center', gap: 2 }, badgeValue: { fontFamily: 'Manrope_600SemiBold', fontSize: 22, fontWeight: '900' }, badgeLabel: { fontSize: 12, fontWeight: '900' }, mapCard: { borderWidth: 1, borderRadius: 22, padding: 16 },
  quickGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 }, metricCard: { width: '48%', borderWidth: 1, borderRadius: 18, padding: 14, gap: 7 }, metricValue: { fontFamily: 'Manrope_600SemiBold', fontSize: 22, fontWeight: '900' }, metricLabel: { fontSize: 12, fontWeight: '800', textTransform: 'uppercase' }, sectionTitle: { fontFamily: 'Manrope_600SemiBold', fontSize: 15, fontWeight: '900' }, sectionSubtitle: { fontSize: 12, lineHeight: 17, marginTop: 3, fontWeight: '600' },
  dropHistoryLink: { borderWidth: 1, borderRadius: 18, padding: 14, flexDirection: 'row', alignItems: 'center', gap: 12 }, dropHistoryIcon: { width: 48, height: 48, borderRadius: 15, alignItems: 'center', justifyContent: 'center' }, dropHistoryTitle: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, letterSpacing: 1, fontWeight: '900' },
  segment: { borderWidth: 1, borderRadius: 17, padding: 4, flexDirection: 'row', gap: 4 }, segmentButton: { flex: 1, borderWidth: 1, borderColor: 'transparent', borderRadius: 13, paddingVertical: 11, alignItems: 'center' }, segmentText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, letterSpacing: 1, fontWeight: '900' }, searchBox: { borderWidth: 1, borderRadius: 16, paddingHorizontal: 13, minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 9 }, searchInput: { flex: 1, fontSize: 13, fontWeight: '700', paddingVertical: 10 }, listHeading: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 3 }, listCount: { fontFamily: 'Manrope_600SemiBold', fontSize: 17, fontWeight: '900' },
  cityCard: { borderWidth: 1, borderRadius: 20, padding: 15 }, progressHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, marginBottom: 9 }, cityName: { fontFamily: 'Manrope_600SemiBold', fontSize: 14, fontWeight: '900', flex: 1 }, cityProvince: { fontSize: 12, fontWeight: '700', marginTop: 3 }, progressPct: { fontFamily: 'Manrope_600SemiBold', fontSize: 14, fontWeight: '900' }, progressTrack: { height: 7, borderRadius: 99, overflow: 'hidden' }, progressFill: { height: '100%', borderRadius: 99 }, cityMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 9 }, cityStatus: { fontSize: 12, fontWeight: '900', letterSpacing: 0.5 }, ownerBox: { borderWidth: 1, borderRadius: 15, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 12 }, ownerName: { fontSize: 13, fontWeight: '900' }, ownerMeta: { fontSize: 12, fontWeight: '700', marginTop: 3 }, myScore: { fontSize: 12, lineHeight: 16, fontWeight: '700', marginTop: 10 },
  dropBox: { borderWidth: 1, borderRadius: 16, padding: 14, flexDirection: 'row', alignItems: 'flex-start', gap: 10 }, dropText: { flex: 1, fontSize: 12, lineHeight: 18, fontWeight: '700' }, emptyText: { padding: 22, textAlign: 'center', fontSize: 12, lineHeight: 18, fontWeight: '700' }, errorText: { fontSize: 12, fontWeight: '800', textAlign: 'center' }, attribution: { textAlign: 'center', fontSize: 12, lineHeight: 16, fontWeight: '600' },
});

        ...
        <View style={{
          ...
          <View style={{ flex: 1 }}>
            <CommunitySearchBar
              ...
              autoFocus
              onClear={() => { setSearch(''); setSearchActive(false); reloadAllClubs(); }}
            />
          </View>
        </View>
      ) : (
          ...
          right={
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
              ...
              <CommunitySearchBarInline
                ...
                onCollapse={() => { setSearch(''); setSearchActive(false); reloadAllClubs(); }}
                value={search}
                onChangeText={handleSearch}
                placeholder="Szukaj klubu..."
              />
              <TouchableOpacity
                style={{
                  backgroundColor: theme.primary, borderRadius: 9,

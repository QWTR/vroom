...
export default function ChatScreen() {
            ...
            {item.photos?.length > 0 && (
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 4 }}>
                {item.photos.map((uri, i) => (
                  <Image
                    key={i} source={{ uri }}
                    style={item.photos.length === 1 ? { width: 200, height: 150, borderRadius: 12 } : { width: 120, height: 90, borderRadius: 8 }}
                  />
                ))}
              </View>
            )}
  ...
  // ── Header height dla keyboardVerticalOffset ───────────
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      ...
      {/* ── KLUCZOWE: KeyboardAvoidingView tylko wokół listy + inputu ── */}
      ...
      >
                ...
                hasMore ? (
                  ...
                  messages.length > 0
                    ? <View style={{ alignItems: 'center', paddingVertical: 12 }}>
                        <Text style={{ color: theme.textDim, fontFamily: 'Orbitron', fontSize: 8, letterSpacing: 1 }}>POCZĄTEK ROZMOWY</Text>
                      </View>
                    : null
                )
              }
        ...
        <View style={{
          ...
          // ← JEDYNA ZMIANA: paddingBottom uwzględnia system nav bar
          ...
          <View style={{ flexDirection: 'row', alignItems: 'flex-end', paddingHorizontal: 10, paddingTop: 10, gap: 8 }}>
            ...
            <TouchableOpacity
              style={[
                { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center', backgroundColor: theme.primary },

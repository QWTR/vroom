...
export default function MarketWatchScreen() {
  ...
  return <SafeAreaView style={[styles.safe, { backgroundColor: theme.bg }]}>
    ...
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      <View style={[styles.coupon, { backgroundColor: theme.surface, borderColor: grants ? '#4de92655' : theme.border }]}><MaterialIcons name="local-offer" size={24} color={grants ? '#4de926' : theme.textDim} /><View style={{ flex: 1 }}><Text style={{ color: grants ? '#4de926' : theme.textDim, fontWeight: '900' }}>{grants ? `${grants} KUPON GOTOWY` : 'BRAK KUPONU'}</Text><Text style={{ color: theme.textDim, fontSize: 10, marginTop: 3 }}>Jeden opłacony miesiąc = jedna promocja ogłoszenia na 7 dni.</Text></View></View>

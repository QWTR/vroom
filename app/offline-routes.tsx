...
function Action({ label, onPress, danger }: any) { return <TouchableOpacity onPress={onPress} style={s.action}><Text style={{ color: danger ? '#ef4444' : '#FFD447', fontSize: 8, fontWeight: '900' }}>{label}</Text></TouchableOpacity>; }
const s = StyleSheet.create({ safe: { flex: 1 }, header: { height: 56, paddingHorizontal: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, title: { fontFamily: 'OrbitronBold', fontSize: 13, letterSpacing: 1.4 }, map: { height: 300, backgroundColor: '#111' }, mapCanvas: { width: '100%', height: '100%' }, mapBadge: { position: 'absolute', right: 14, bottom: 14, borderRadius: 10, backgroundColor: '#090909dd', borderWidth: 1, borderColor: '#FFD44755', paddingHorizontal: 10, paddingVertical: 7 }, mapBadgeText: { color: '#FFD447', fontSize: 9, fontWeight: '900' }, content: { padding: 14, gap: 11, paddingBottom: 38 }, card: { borderWidth: 1, borderRadius: 15, padding: 15, gap: 11 }, label: { fontFamily: 'Orbitron', fontSize: 10, fontWeight: '900' }, routePill: { minHeight: 40, borderWidth: 1, borderRadius: 11, justifyContent: 'center', paddingHorizontal: 12 }, bufferRow: { flexDirection: 'row', gap: 8 }, buffer: { flex: 1, minHeight: 42, borderWidth: 1, borderRadius: 11, alignItems: 'center', justifyContent: 'center' }, switchRow: { minHeight: 46, flexDirection: 'row', alignItems: 'center', gap: 8 }, actions: { flexDirection: 'row', gap: 7 }, action: { flex: 1, borderWidth: 1, borderColor: '#ffffff18', borderRadius: 9, paddingVertical: 11, alignItems: 'center' }, download: { minHeight: 52, backgroundColor: '#FFD447', borderRadius: 13, alignItems: 'center', justifyContent: 'center' }, downloadText: { color: '#111', fontSize: 10, fontWeight: '900' }, retry: { color: '#FFD447', fontSize: 9, fontWeight: '900', textAlign: 'center' }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 32, gap: 16 }, blockTitle: { fontFamily: 'OrbitronBold', fontSize: 16, letterSpacing: 1.5 }, blockText: { textAlign: 'center', fontSize: 12, lineHeight: 19 } });

...
type PassReward = { lockedReason?: string | null; nextAvailableAt?: string | null; id: string; track: 'free' | 'premium'; type: string; name: string; description?: string | null; amount?: number | null; metadata?: { fulfillmentType?: string; instructions?: string } | null; grant?: { id: string; status: string; claimBy?: string | null } | null };
type PassData = { pass: null | { id: string; levelCount: number; durationDays: number; priceGross: number; currency: string; salesStartAt?: string | null; salesEndAt?: string | null }; progress?: { xp: number; currentLevel: number; levelStartXp?: number; nextLevelXp?: number | null; completed: boolean }; premium?: { active: boolean; status: string; expiresAt?: string | null }; xpRules?: { driveXpPerKm: number; dailyDriveXpCap: number; questPointsXpMultiplier: number; achievementXpMultiplier: number }; daily?: { driveXp: number }; levels?: { id: string; level: number; requiredXp: number; unlocked: boolean; rewards: PassReward[] }[] };
...
const styles = StyleSheet.create({
  ...
  loadingText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, letterSpacing: 1 },
  ...
  headerTitle: { fontFamily: 'Manrope_600SemiBold', fontSize: 14, fontWeight: '900', letterSpacing: 1 },
  ...
  heroTitle: { color: '#fff', fontFamily: 'Manrope_600SemiBold', fontSize: 25, lineHeight: 30, fontWeight: '900' },
  heroCountdown: { color: '#FFD447', fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '800', marginTop: 8 },
  actionRow: { flexDirection: 'row', gap: 8 },
  primaryAction: { flex: 1, minHeight: 46, borderRadius: 13, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 },
  primaryActionText: { color: '#fff', fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900', letterSpacing: .6 },
  ...
  secondaryActionText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900', letterSpacing: .4 },
  section: { padding: 15, borderWidth: 1, borderRadius: 18, gap: 10 },
  sectionTitle: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900', letterSpacing: 1 },
  body: { fontFamily: 'Satoshi', fontSize: 12, lineHeight: 18 },
  date: { fontFamily: 'Satoshi', fontSize: 12 },
  ...
  statValue: { fontFamily: 'Manrope_600SemiBold', fontSize: 15, fontWeight: '900' },
  statLabel: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '800', letterSpacing: .5 },
  ...
  placeText: { color: '#FFD447', fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900' },
  rowTitle: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900' },
  rowMeta: { fontFamily: 'Satoshi', fontSize: 12, marginTop: 3 },
  ...
  rarity: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900' },
  progressTrack: { height: 4, borderRadius: 2, overflow: 'hidden', marginTop: 8 },
  progressFill: { height: 4, borderRadius: 2 },
  progressText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, marginTop: 4, textAlign: 'right' },
  passHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 },
  passLevel: { fontFamily: 'Manrope_600SemiBold', fontSize: 16, fontWeight: '900' },
  ...
  passTabText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900', letterSpacing: .5 },
  ...
  passNumber: { fontFamily: 'Manrope_600SemiBold', fontSize: 18, fontWeight: '900' },
  passXp: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, marginTop: 2, marginBottom: 8 },
  passLane: { minHeight: 79, padding: 7, borderTopWidth: 1 },
  passLaneLabel: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900', marginBottom: 5 },
  passReward: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 4 },
  passRewardName: { fontFamily: 'Satoshi', fontSize: 12, fontWeight: '700', textAlign: 'center' },
  passClaim: { paddingHorizontal: 8, paddingVertical: 5, borderRadius: 7 },
  passState: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900' },
  passEmpty: { fontFamily: 'Satoshi', fontSize: 12, textAlign: 'center', marginTop: 12 },
  ...
  missionPeriodText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900', letterSpacing: .35 },
  ...
  missionTitle: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900' },
  missionMeta: { fontFamily: 'Satoshi', fontSize: 12, marginTop: 3 },
  missionXp: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900', textAlign: 'right', maxWidth: 84 },
  missionProgress: { height: 5, borderRadius: 3, overflow: 'hidden' },
  missionProgressFill: { height: 5, borderRadius: 3 },
  missionFoot: { fontFamily: 'Satoshi', fontSize: 12 },
  missionReset: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
  missionHint: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900', letterSpacing: .5 },
  missionResetText: { fontFamily: 'Manrope_600SemiBold', fontSize: 12, fontWeight: '900' },
